 ...
 */
public class ConnectionHandler<T>  implements ProtocolCallback{
	...
	private ConnectionHandler(SocketChannel sChannel, ReactorData<T> data, SelectionKey key) {
		_sChannel = sChannel;
		_data = data;
		_protocol = new protocolClient(data.getProtocol(), this);
	...
	public void sendMessage(Object msg) throws IOException {
		...
		try {
			ByteBuffer bytes = _tokenizer.getBytesForMessage((T) new StringMessage((String) msg));
